    ...
    >
      ...
      <div className="mt-4 md:mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        <div className="md:col-span-1">
          ...
          <h3 className="mt-3 text-xl md:text-2xl font-semibold tracking-tight text-white break-words hyphens-auto leading-tight">
            {active.title}
          </h3>
          <div className="mt-3 space-y-2 text-sm text-white/80">
            {active.lines?.map((l, i) => (
              <div key={i} className="flex items-start gap-2">
                ...
                <span className="break-words leading-relaxed">{l}</span>
              </div>
            ))}
          </div>
