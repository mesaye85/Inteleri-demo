      ...
      <div className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted max-w-3xl mx-auto mb-4 md:mb-6 break-words leading-relaxed">
          ...
          >
            <GlassCard className="p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-text mb-4 md:mb-6 break-words leading-tight">
              ...
              <div className="prose prose-lg text-muted max-w-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold text-neon-1 mb-3 md:mb-4 break-words leading-tight">Standardized</h3>
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold text-neon-2 mb-3 md:mb-4 break-words leading-tight">Secure</h3>
                    <p className="text-sm md:text-base text-muted break-words leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold text-neon-3 mb-3 md:mb-4 break-words leading-tight">Scalable</h3>
                    <p className="text-sm md:text-base text-muted break-words leading-relaxed">
                  ...
                  >
                    <GlassCard className="h-full">
                      <div className="text-center mb-4">
                        ...
                        <p className="text-sm md:text-base text-muted mb-4 break-words leading-relaxed">
            ...
            <GlassCard className="p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-text mb-2 break-words leading-tight">Agent Node 1</h3>
                  <p className="text-xs md:text-sm text-muted break-words leading-relaxed">
                ...
                >
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-text mb-2 break-words leading-tight">MCP Hub</h3>
                  <p className="text-xs md:text-sm text-muted break-words leading-relaxed">
                ...
                >
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-text mb-2 break-words leading-tight">Agent Node 2</h3>
                  <p className="text-xs md:text-sm text-muted break-words leading-relaxed">
                    Risk Assessment<br />
