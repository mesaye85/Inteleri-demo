                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                  {roboticsScope.map((scope) => (
                    <div key={scope.category}>
                      <h3 className="text-lg md:text-xl font-semibold text-text mb-3 md:mb-4 break-words leading-tight">
                        {scope.category}
                      </h3>
                      <p className="text-sm md:text-base text-muted mb-3 md:mb-4 break-words leading-relaxed">
                        {scope.description}
                      </p>
                      <div className="space-y-2">
                        {scope.examples.map((example) => (
                          <div key={example} className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-neon-1 rounded-full mt-1.5 flex-shrink-0" />
                            <span className="text-xs md:text-sm text-muted break-words leading-relaxed">{example}</span>
                          </div>
                        ))}
                      </div>
                    </div>
            ...
            <GlassCard className="p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-text mb-2 break-words leading-tight">Robot Layer</h3>
