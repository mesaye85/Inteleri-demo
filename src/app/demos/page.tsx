                  ...
                  <GlassCard className="p-6 md:p-8">
                    ...
                    <div className="flex items-start space-x-6 mb-8">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-base md:text-lg lg:text-xl text-muted mb-3 md:mb-4 break-words leading-relaxed">
                          {demo.description}
                        </p>
                        ...
                        >
                          ...
                          <div className="relative z-10">
                            <div className="text-center mb-4">
                              ...
                              <h3 className="text-base md:text-lg font-semibold text-text mb-2 break-words leading-tight">
                                {step.title}
                              </h3>
                              <p className="text-xs md:text-sm text-muted mb-3 md:mb-4 break-words leading-relaxed">
                                {step.description}
                              </p>
                            </div>
          ...
          >
            <GlassCard>
              <div className="text-center">
                ...
                <p className="text-base md:text-lg lg:text-xl text-muted mb-6 md:mb-8 max-w-2xl mx-auto break-words leading-relaxed">
