...
export default function NavBarServer() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent" aria-label="Primary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Desktop Navigation */}
          <div id="server-primary-navigation" className="hidden md:flex items-center space-x-8">
            {navigation.map((item) => (
              <Link
                key={item.label}
                href={item.href}
          ...
          <div className="md:hidden">
            <button
              ...
              aria-expanded="false"
              aria-controls="server-primary-navigation"
            >
