              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/[0.08] border border-white/10">
                  ...
                  <div className="mt-4 flex items-center gap-2 text-xs text-cyan-300 opacity-0 group-hover:opacity-100 transition-opacity">
